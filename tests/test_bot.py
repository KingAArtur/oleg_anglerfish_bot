...
async def test_command_horoscope(bot, user):
    ...
    expected_reply_text = (
        'DrillerName, мне приснилось, как ты пожалел эффективность. Выглядел волнительно!\n\n'
        'Это будет удачный день!\n'
        'Ты победишь в какой-нибудь игре, но стоит вовремя остановиться!\n'
        'Сегодня ты встретишь человека, чье имя начинается на букву Т.\n'
        'Кто-то очень захочет жахнуть тебя сегодня. Отнесись с уважением!\n\n'
        'Пришли кому-нибудь мемчик, человек очень ждет этого!\n'
        'Сегодня ты назовешь кого-то чужим именем.\n\n'
    )
